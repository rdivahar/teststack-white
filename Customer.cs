    ...
    public class Customer : WindowActions
    {
        ...
        public bool CloseCustomerWindow()
        {
            ...
            try
            {
                ...
                //return wCustomerWin.IsOffScreen;             
                return true;
            }
            catch
            {
        ...
        public bool SelectCustomerTest(string sCustomer)
        {
            ...
            try
            {
                ...
                //wCustomerWin = GetChildWindowByID(wVStoreMainWindow, AppConstants.WIN_CUSTOMER_FORM);
        ...
        /// </summary>
            ...
            try
            {
                ...
                Thread.Sleep(10000);
                // wAction.ClickOnButton(wCustomerAddWin, "fBtnCancel");
        ...
        {
            //Window wCustomerWin = wCustomerWindow();
        ...
        public bool VerifyCustomerIsSet(string sExpectedCustName)
        {
            ...
            //Label lblCustTagName = GetLabel(AppConstants.LBL_TAG_CUSTINFO);
            //Boolean bCustTagInfoAvail = lblCustTagName.Text.Contains(sExpectedCustName);
